...
@Desc    :   Module for Raspberry Pi image input.
"""
...
class Input(AbstractInput):
    ...
    """Raspberry Pi image input class."""

    def __init__(self, **kwargs):
        """Initialize Raspberry Pi image input class."""
        self.image_path = ""
