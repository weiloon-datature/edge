...
@Desc    :   Module for Raspberry Pi OpenCV output.
"""
...
class Output(AbstractOutput):
    ...
    """Raspberry Pi OpenCV output class."""

    def __init__(self, **kwargs):
        """Initialize Raspberry Pi OpenCV output class."""
        self.type = ""
        self.output_path = ""
        self.window_name = ""
        self.frame_size = [-1, -1]
    ...
    def run(self, assets):
        """Run Raspberry Pi OpenCV output module.

        Args:
            input_assets: Dictionary of input assets.
            output_assets: Dictionary of output assets.
        ...
        if self.type == "image_show":
            ...
            raise InvalidOutputTypeException("Invalid output type provided!")
