...
class Engine(AbstractEngine):
    ...
    def run(self):
        ...
        Raises:
            JetsonEngineException: If engine fails to run.
        """
        if not self._inference_engine or not self._input_module:
            raise JetsonEngineException(
        ...
        try:
            ...
            raise JetsonEngineException(exc) from exc
        finally:
            self._cleanup()
